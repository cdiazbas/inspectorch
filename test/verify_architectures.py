#!/usr/bin/env python
"""
Verification script to test that all flow matching backends support all velocity models.
"""
...
for backend in backends:
    ...
    for arch in architectures:
        try:
            ...
            model.create_flow(input_size=2, architecture=arch, num_layers=2, hidden_features=32)
            print("✓ SUCCESS")
